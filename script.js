(function () {
    ...
    const CONFIG = {
        ...
        officialDomain: 'https://fafa828.xyz/fafa828'
    };
    ...
    const startPopup = function () {
        ...
        style.textContent = `
            ...
            @keyframes pgxShieldPulse {
                0%, 100% { transform: scale(1); filter: drop-shadow(0 0 2px rgba(193, 154, 73, 0.4)); }
                50% { transform: scale(1.08); filter: drop-shadow(0 0 10px rgba(193, 154, 73, 0.8)); }
            }
            ...
            #pgx_glow_effect {
                ...
                inset: 0;
                pointer-events: none;
                background: radial-gradient(320px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(193, 154, 73, 0.08) 0%, rgba(43, 177, 105, 0.05) 50%, transparent 80%);
            ...
            #pgx_final_close:hover { 
                ...
                color: #fff; 
                border-color: rgba(193, 154, 73, 0.6);
                box-shadow: 0 0 10px rgba(193, 154, 73, 0.3);
            }
            #pgx_final_close:focus-visible {
                border-color: #ffcf75;
                box-shadow: 0 0 0 2px rgba(193, 154, 73, 0.4);
            }
            ...
            .pgx-header {
                ...
                border-bottom: 1px solid rgba(193, 154, 73, 0.15);
                position: relative;
                z-index: 2;
            }
            .pgx-header-logo {
            ...
            .pgx-banner-wrapper:hover {
                border-color: rgba(193, 154, 73, 0.65);
                box-shadow: 0 10px 25px rgba(193, 154, 73, 0.25);
            ...
            .pgx-line { 
                border-color: rgba(76, 149, 58, 0.22);
            }
            .pgx-line .pgx-btn-icon-wrapper {
                background: linear-gradient(135deg, rgba(76, 149, 58, 0.3) 0%, rgba(76, 149, 58, 0.1) 100%);
                border-color: rgba(76, 149, 58, 0.35);
            }
            .pgx-line:hover {
                background: rgba(76, 149, 58, 0.08);
                border-color: rgba(76, 149, 58, 0.65);
                box-shadow: 0 6px 20px rgba(76, 149, 58, 0.25), inset 0 1px 0 rgba(255,255,255,0.06);
            }
            ...
            .pgx-info-head {
                ...
                margin-bottom: 10px;
                padding-bottom: 8px;
                border-bottom: 1px solid rgba(193, 154, 73, 0.12);
            }
            .pgx-info-badge {
                flex-shrink: 0;
                width: 30px;
                ...
                align-items: center;
                justify-content: center;
                background: linear-gradient(180deg, rgba(193, 154, 73, 0.18) 0%, rgba(193, 154, 73, 0.04) 100%);
                border: 1px solid rgba(193, 154, 73, 0.32);
            }
            .pgx-shield-svg {
                width: 16px;
                height: 16px;
            ...
            .pgx-copy-container {
                ...
                border: 1px solid rgba(193, 154, 73, 0.12);
                display: flex;
                flex-direction: column;
                align-items: center;
                gap: 12px;
            ...
            .pgx-copy-input-group {
                ...
                max-width: 290px;
                border-radius: 10px;
                background: rgba(193, 154, 73, 0.04);
                border: 1px solid rgba(193, 154, 73, 0.22);
            ...
            .pgx-copy-input-group:focus-visible {
                border-color: #ffcf75;
                box-shadow: 0 0 0 2px rgba(193, 154, 73, 0.3);
            }
            .pgx-copy-val {
                font-size: 14px;
                font-weight: 700;
            ...
            .pgx-btn:focus-visible {
                border-color: #ffcf75;
                box-shadow: 0 0 0 2.5px rgba(193, 154, 73, 0.5), inset 0 1px 0 rgba(255,255,255,0.15);
            }
        `;
                ...
                <div id="pgx_final_container">
                    ...
                    <div class="pgx-header">
                        <div class="pgx-header-logo">
                            <img src="${resolvedLogoUrl}" width="240" height="80" alt="fafa828 LOGO" decoding="async" loading="eager">
                        </div>
                    </div>
                    
                    <div id="pgx_final_content">
                        <h1 class="pgx-content-heading" id="pgx_title">Fafa828 ทางเข้า VIP</h1>
                            ...
                            <a class="pgx-btn pgx-line" href="${L.line}" target="_blank" rel="noopener" tabindex="0">
                                <div class="pgx-btn-icon-wrapper">
                                    <svg class="pgx-btn-svg" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M12 2C6.48 2 2 5.82 2 10.53c0 2.63 1.41 4.96 3.62 6.46-.1.61-.37 2.22-.42 2.53-.08.45.18.45.38.31.29-.2 4.14-2.81 4.54-3.07.61.17 1.25.26 1.88.26 5.52 0 10-3.82 10-8.53S17.52 2 12 2z"/>
                                    </svg>
                                </div>
                                <div class="pgx-btn-text">
                                    <span class="pgx-btn-title">LINE OFFICIAL 💬</span>
                                    <span class="pgx-btn-sub">ศูนย์บริการสมาชิก<br>เจ้าหน้าที่พร้อมให้ความช่วยเหลือคุณตลอด 24 ชม.</span>
                                </div>
                        ...
                        <div class="pgx-info-box" role="note">
                            <div class="pgx-info-head">
                                ...
                                <span class="pgx-info-title">ใช้งาน Fafa828 อย่างปลอดภัย</span>
                            </div>
                            <p class="pgx-info-desc">เพื่อปกป้องบัญชีและข้อมูลของคุณ โปรดเข้าสู่ระบบผ่านช่องทางหลักของ Fafa828 เท่านั้น และไม่ควรทำรายการหรือโอนเงินผ่านบุคคลภายนอกเว็บไซต์</p>
                            ...
                            <div class="pgx-copy-container">
                                <div class="pgx-copy-input-group" id="pgx_copy_link_btn" role="button" tabindex="0" aria-label="คัดลอกเว็บทางการ">
                                    ...
                                    <div class="pgx-copy-tooltip" id="pgx_copy_tooltip">
                                        <span class="pgx-copy-tooltip-text">คัดลอกลิงก์สำเร็จ!</span>
                                    </div>
                                </div>
                                <span class="pgx-copy-label">ช่องทางหลักของ Fafa828</span>
                            </div>
                        </div>
                        
                        <div class="pgx-footer-text">
                            © 2026 Fafa828 ลิขสิทธิ์เนื้อหาทั้งหมดเป็นของ
                        </div>
                    </div>
                </div>
            </div>
